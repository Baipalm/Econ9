...
st.sidebar.subheader("Total Production Labour")
L = st.sidebar.slider("Labour", min_value=10, max_value=100, value=50, step=10, label_visibility="invisible")
...
st.line_chart(oranges, x_label="🐸", y_label="🟠")
